...
plt.figure()
plt.plot(x_final, y_final, c = 'g', ls = "-", lw = 1.5, label = 'Reverse')
plt.plot(x_valuesF, y_valuesF, c = 'r', ls = "--", lw = 1.5, label = 'Forward')
plt.legend(loc='upper left', bbox_to_anchor=(0, 1.02), fontsize=8, frameon = False, columnspacing=1.25,handlelength=3)
plt.title('Reverse Bias Characteristics', fontsize = 20, fontweight = "bold")
